<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Masterpage.Master" AutoEventWireup="true" CodeBehind="CRUD.aspx.cs" Inherits="Inicio.Page.CRUD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form class="form_" runat="server">
        ...
        <section class="text-center" style="padding-top:70px;">
            ...
            <div class="card mx-4 mx-md-5 shadow-5-strong" style="margin-top: -100px; background-color: white; border:none;">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <h2 class="fw-bold mb-5">Regístrate ahora</h2>
                                ...
                                <!-- Submit button -->
                                <asp:button type="submit" class="btn btn-primary btn-block mb-4" style="width:70%; background-color:#3E54AC; border:none;" 
                                   Text="Enviar" OnClick="Enviar_Click" runat="server"/>
